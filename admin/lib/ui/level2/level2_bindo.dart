...
class Level_bindo extends StatefulWidget {
  @override
  _LevelScreenState createState() => _LevelScreenState();
}

class _LevelScreenState extends State<Level_bindo> {
  ...
  void addNewLevel() async {
    final bool? shouldAdd = await Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => Ques2Bindo(level: levels.length + 1)),
    );
