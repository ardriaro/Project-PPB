...
class Level1_ingg extends StatefulWidget {
  @override
  _LevelScreenState createState() => _LevelScreenState();
}

class _LevelScreenState extends State<Level1_ingg> {
  ...
  void addNewLevel() async {
    final bool? shouldAdd = await Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => Ques1Ingg(level: levels.length + 1)),
    );
