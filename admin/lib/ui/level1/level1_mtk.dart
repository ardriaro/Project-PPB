...
class Level1_mtk extends StatefulWidget {
  @override
  _LevelScreenState createState() => _LevelScreenState();
}

class _LevelScreenState extends State<Level1_mtk> {
  ...
  void addNewLevel() async {
    final bool? shouldAdd = await Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => Ques1Mtk(level: levels.length + 1)),
    );
