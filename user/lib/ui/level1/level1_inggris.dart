...
import 'ques1_ingg.dart';
import 'package:cloud_firestore/cloud_firestore.dart';

class LevelScreen_inggris1 extends StatefulWidget {
  static const String routeName = '/level1_inggris';

  @override
  _LevelScreen_inggris1State createState() => _LevelScreen_inggris1State();
}

class _LevelScreen_inggris1State extends State<LevelScreen_inggris1> {
  ...
  void navigateToLevelPage(BuildContext context, int level) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => Ques1Ingg(level: level),
      ),
    ).then((shouldUpdate) {
