...
import 'ques1_mtk.dart';
import 'package:cloud_firestore/cloud_firestore.dart';

class LevelScreen_matematika1 extends StatefulWidget {
  static const String routeName = '/level1_matematika';

  @override
  _LevelScreen_matematika1State createState() =>
      _LevelScreen_matematika1State();
}

class _LevelScreen_matematika1State extends State<LevelScreen_matematika1> {
  ...
  void navigateToLevelPage(BuildContext context, int level) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => Ques1mtk(level: level),
      ),
    ).then((shouldUpdate) {
