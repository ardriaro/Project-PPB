...
import 'ques2_ingg.dart';
import 'package:cloud_firestore/cloud_firestore.dart';

class LevelScreen_inggris2 extends StatefulWidget {
  static const String routeName = '/level2_inggris';

  @override
  _LevelScreen_inggris2State createState() => _LevelScreen_inggris2State();
}

class _LevelScreen_inggris2State extends State<LevelScreen_inggris2> {
  ...
  void navigateToLevelPage(BuildContext context, int level) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => Ques2Ingg(level: level),
      ),
    ).then((shouldUpdate) {
